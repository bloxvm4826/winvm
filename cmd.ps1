...
function Respawn {
  Act
  for ($k = 0; $k -lt 2; $k++) {
    Click 282 125 250; Start-Sleep 3               # CloudMoon Esc btn -> Roblox menu
    Click 480 681 250; Start-Sleep 3               # Respawn
    Click 681 476 250; Start-Sleep 10              # confirm
    if (-not (Drowned)) { break }
  }
